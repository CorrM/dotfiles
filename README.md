...
```bash
pacman -Syu
pacman -S --needed grim slurp xorg-xhost bluez bluez-utils bluedevil stow waybar sddm alacritty dunst fastfetch pamixer bash-completion cliphist mpd archlinux-xdg-menu pavucontrol wl-clipboard noto-fonts ttf-dejavu ttf-liberation ttf-jetbrains-mono-nerd otf-font-awesome
